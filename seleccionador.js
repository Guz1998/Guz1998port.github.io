...
// Agregar un evento de cambio al filtro de categorías
filtroCategorias.addEventListener("change", function () {
  ...
  var elementos = document.getElementsByClassName("contenedor-edicion");

  // Recorrer los elementos y mostrar/ocultar según la categoría seleccionada
  for (var i = 0; i < elementos.length; i++) {
    ...
    if (
      ...
      categoriaSeleccionada === categoriaElemento
    ) {
